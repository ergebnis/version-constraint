...
final class TildeVersionRangeProvider extends VersionConstraint\Test\DataProvider\Composer\AbstractDataProvider
{
    ...
    public static function valid(): \Generator
    {
        yield from self::provideValues([
            ...
            'tilde-major-minor-asterisk-dev' => '~2.*-dev',
            'tilde-major-minor-asterisk-separator-dot-dev' => '~2.*.dev',
            'tilde-major-minor-asterisk-separator-none-dev' => '~2.*dev',
            'tilde-major-minor-uppercase-x-dev' => '~2.X-dev',
            'tilde-major-minor-x-dev' => '~2.x-dev',
            'tilde-major-minor-x-dev-and-build-metadata' => '~2.x-dev+meta',
            ...
            'tilde-major-one-minor-patch-and-build-metadata' => '~1.2.3+20130313144700',
            ...
            'tilde-major-one-minor-stability-beta-and-dev' => '~1.2-beta-dev',
            'tilde-major-one-minor-stability-beta-and-large-number' => '~1.2-beta10',
            'tilde-major-one-minor-stability-beta-and-number' => '~1.2-b2',
            'tilde-major-one-minor-stability-beta-and-numbers' => '~1.2-beta1.2.3',
            'tilde-major-one-minor-stability-beta-separator-dash-and-number' => '~1.2-b-2',
            'tilde-major-one-minor-stability-beta-separator-dash-and-numbers' => '~1.2-beta-1-2',
            ...
            'tilde-major-one-minor-stability-uppercase-beta' => '~1.2-BETA',
            'tilde-major-one-minor-stability-uppercase-dev' => '~1.2-DEV',
            'tilde-major-one-minor-stability-uppercase-rc' => '~1.2-RC',
            'tilde-major-one-minor-zero' => '~1.0',
            'tilde-major-one-minor-zero-and-build-metadata' => '~1.0+build',
            'tilde-major-one-minor-zero-patch-zero' => '~1.0.0',
            'tilde-major-one-stability-beta' => '~1-beta',
            'tilde-major-one-trailing-separator-dash' => '~1-',
            'tilde-major-one-trailing-separator-dot' => '~1.',
            'tilde-major-one-trailing-separator-underscore' => '~1_',
            'tilde-major-zero' => '~0',
            'tilde-major-zero-minor-x-dev' => '~0.x-dev',
            'tilde-uppercase-v-major-one' => '~V1',
